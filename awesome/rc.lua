...
globalkeys = gears.table.join(
    ...
    awful.key({}, "XF86MonBrightnessUp", function() gears.spawn("xbacklight -inc 5")  end),
    awful.key({}, "XF86MonBrightnessDown", function() gears.spawn("xbacklight -dec 5")  end),

    awful.key({}, "XF86Sleep", function() gears.spawn("")  end),
...
awful.spawn(terminal .. " -e /home/nico/90-arandr.sh")
-- }}}
