...
config.bind('<Space>k', 'open -t https://kwik.kitware.com/keu/time_entries/time_card')
config.bind('<Space>c', 'open -t https://calendar.google.com/calendar/u/0/r/week')
config.bind('<Space>p', 'set-cmd-text -s :open --private')
